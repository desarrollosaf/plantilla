...
return [
    'custom' => [
        ...
        'templateTitle' => 'Amnistia', //template Title can be changes default('Materialize)
        ...
        'largeScreenLogo' => 'images/logo/NLogo.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'images/logo/NLogo.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
